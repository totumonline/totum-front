...
"bugFinder-warning":"Тестирование происходит в несохраняющемся режиме и безопасно для базы данных, но может вызвать сторонние сервисы и отправить email, если эти функции задействованы в цепочке кодов открываемой страницы.",
"Enter the path to the table":"Введите путь к таблице",
"Stop":"Стоп",
"Start":"Старт",
...
"userNotFoundError":"Пользователь был разлогинен тк она был отключен или было превышено количество доступных одновременных подключений"
}
