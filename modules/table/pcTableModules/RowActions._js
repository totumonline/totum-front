(function (window, $) {
    $.extend(App.pcTableMain.prototype, {
        ...
        apptyTableFormats: function (newf) {
            ['blockadd', 'buttons', 'blockdelete', 'blockorder', 'background', 'blockduplicate', 'block', 'tabletitle', 'rowstitle', 'fieldtitle', 'tablecomment', 'tabletext', 'browsertitle', 'fieldhide', 'kanban_html'].forEach((k) => {
